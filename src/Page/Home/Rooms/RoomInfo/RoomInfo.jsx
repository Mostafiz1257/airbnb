      ...
      <div className='flex flex-col gap-2'>
        <div
          className='
            ...
            '
        >
          <div>Hosted by <span className=" text-red-500">{roomData.host.name}</span></div>

          <img
            className='rounded-full border-solid border-2 border-red-300'
            height='30'
            width='30'
            alt='Avatar'
        ...
        <div
          className='
            ...
            '
        >
          <div>{roomData.total_guest} guest</div>
          <div>{roomData.bedrooms} bedroom</div>
